...
SECRET_KEY = 'django-insecure-gt%m5ib(esb!*^o18)gj@j+qzrt47rg*x-g$ix=z)9q&4&990t'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'charset': 'utf8mb4',  # кодировка соответствующая установленной в MariaDB
            'init_command': "SET sql_mode='STRICT_TRANS_TABLES'",  # режим SQL для совместимости
        },
    }
}
